...
function(){var b=a(this).find(".tweet_list");b.css("padding-left",0);if(1<b.children().size()){var c=function(){setTimeout(function(){var d=b.find("li:first");d.animate({marginTop:-1*d.height()},400,function(){a(this).detach().appendTo(b).removeAttr("style")});c()},5E3)};c()}})})};a.src="https://raw.github.com/samet/eksitwitter/master/jquery.tweet.js";b.getElementsByTagName("head")[0].appendChild(a)})(window.document)}0<=window.document.URL.indexOf("www.eksisozluk.com/show.asp")&&addJQuery(main);
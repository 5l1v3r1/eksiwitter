...
count:4,query:b+" lang:tr",loading_text:"tweetler yolda...",filter:function(a){return!/^@\w+/.test(a.tweet_raw_text)},template:"{avatar}{user} {join}{text}"}).bind("loaded",function(){0<document.height-(window.pageYOffset+window.innerHeight)&&a("body").css("overflow-y","scroll");var b=a(this).find(".tweet_list");b.css("padding-left",0);if(1<b.children().size()){a("#twitterWidget").height();var c=function(){setTimeout(function(){var d=b.find("li:first");d.animate({marginTop:-1*d.height()},500,function(){a(this).detach().appendTo(b).removeAttr("style")});
c()},5E3)};c()}})})};a.src="https://raw.github.com/samet/eksiwitter/master/jquery.tweet.min.js";b.getElementsByTagName("head")[0].appendChild(a)})(window.document)}0<=window.document.URL.indexOf("www.eksisozluk.com/show.asp")&&addJQuery(main);
